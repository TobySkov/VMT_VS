...
plt.plot(radiance_timings[:16,0], label = "dctimestep")
plt.plot(radiance_timings[:16,1], label = "rmtxop")
...
plt.figure(figsize=(6,3),dpi=500)
plt.plot(numpy_timings[:16,0], label = "reading dc matrix")
plt.plot(numpy_timings[:16,1], label = "reading sky matrix")
plt.plot(numpy_timings[:16,2], label = "matmul")
plt.plot(numpy_timings[:16,3], label = "scale")
plt.plot(numpy_timings[:16,4], label = "save result matrix")
plt.xlabel("Number of sensor points", fontsize=12)
plt.ylabel("Walltime [s]", fontsize=12)
...
#%% numpy without save results and read dc
...
#%% numpy without save results and read dc and sky matrix
...
plt.figure(figsize=(6,3),dpi=500)
plt.plot(cupy_timings[:16,0], label = "reading dc matrix")
plt.plot(cupy_timings[:16,1], label = "reading sky matrix")
plt.plot(cupy_timings[:16,2], label = "copy dc matrix")
plt.plot(cupy_timings[:16,3], label = "copy sky matrix")
plt.plot(cupy_timings[:16,4], label = "matmul")
plt.plot(cupy_timings[:16,5], label = "scale")
plt.plot(cupy_timings[:16,6], label = "copy results matrix")
plt.plot(cupy_timings[:16,7], label = "save result matrix")
plt.xlabel("Number of sensor points", fontsize=12)
plt.ylabel("Walltime [s]", fontsize=12)
...
#%% cupy without save results and without reading matrices
x = list(range(16))
...
plt.figure(figsize=(6,3),dpi=500)
plt.plot(cupy_timings[:16,2] + cupy_timings[:,3] + cupy_timings[:,6], label = "cupy - copy op.")
plt.plot(cupy_timings[:16,4] + cupy_timings[:,5], label = "cupy - matrix op.")
plt.plot(numpy_timings[:16,2] + numpy_timings[:16,3], label = "numpy - matrix op.")
plt.xlabel("Number of sensor points", fontsize=12)
plt.ylabel("Walltime [s]", fontsize=12)
...
plt.figure(figsize=(6,3),dpi=500)
plt.plot(cupy_timings[:16,2] + cupy_timings[:,3] + cupy_timings[:,6] + cupy_timings[:,4] + cupy_timings[:,5], label = "cupy - copy op. and matrix op.")
plt.plot(numpy_timings[:16,2] + numpy_timings[:16,3], label = "numpy - matrix op.")
plt.xlabel("Number of sensor points", fontsize=12)
plt.ylabel("Walltime [s]", fontsize=12)
plt.title("cupy vs numpy runtime", fontsize=14)
...
plt.figure(figsize=(6,3),dpi=500)
plt.plot(radiance_timings.sum(axis=1)[:16]/numpy_timings.sum(axis=1)[:16], label = "numpy speed up")
plt.xlabel("Number of sensor points", fontsize=12)
plt.ylabel("Speedup", fontsize=12)
plt.title("Speedup of matrix operations in numpy compared to Radiance", fontsize=14)
plt.grid()
plt.legend()
plt.xticks(x, labels=no_sensor_points_list[0:16], rotation = 70, fontsize=12)
plt.show()
